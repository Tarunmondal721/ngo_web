...
export default function EventsPage() {
  ...
  const filteredPastEvents =
    selectedCategory === "All" ? pastEvents : pastEvents.filter((event) => event.category === selectedCategory)
    ...
    <div className="min-h-screen">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          {activeTab === "upcoming" && (
            <>
              ...
              {filteredUpcomingEvents.find((event) => event.featured) && (
                <div className="mb-16">
                  <h2 className="font-heading font-bold text-3xl text-foreground mb-8 text-center">Featured Event</h2>
                  {(() => {
                    const featuredEvent = filteredUpcomingEvents.find((event) => event.featured)!
                    return (
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2">
                          ...
                          <CardContent className="p-8 flex flex-col justify-center">
                            ...
                            <div className="flex items-center justify-between">
                              <span className="font-semibold text-lg text-primary">{featuredEvent.price}</span>
                              <Button size="lg">
                                Register Now
                    ...
                    .map((event) => (
                      <Card key={event.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                        ...
                        <CardHeader className="pb-3">
                          <CardTitle className="font-heading text-xl leading-tight">{event.title}</CardTitle>
                        </CardHeader>
          ...
          {activeTab === "past" && (
            <div>
              <h2 className="font-heading font-bold text-3xl text-foreground mb-8 text-center">Past Events</h2>
                  ...
                  <Card key={event.id} className="overflow-hidden">
                    ...
                    <CardContent className="pt-0">
                      ...
                      <div className="bg-primary/10 rounded-lg p-3">
                        <p className="font-medium text-primary text-sm">Impact: {event.impact}</p>
                      </div>
                    </CardContent>
                  </Card>
                ))}
