    ...
    <div className="max-w-5xl mx-auto mt-20 p-6 bg-white shadow-md rounded-lg">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
          ...
          >
            <div className="relative bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl shadow-2xl rounded-3xl p-10 border border-white/20 space-y-8">
              {/* Header */}
              <div className="text-center">
                <h2 className="text-3xl font-extrabold bg-gradient-to-r from-indigo-500 via-pink-500 to-purple-500 bg-clip-text text-transparent animate-gradient-x">
                  ✨ Create New Blog
                </h2>
                <p className="text-sm text-gray-500 mt-2">
                  Share your story beautifully with readers worldwide 🌍
                </p>
              </div>

              {/* Form */}
              <form onSubmit={handleCreateBlog} className="space-y-6" encType="multipart/form-data">
                {/* Category */}
                <div>
                  ...
                  <Select
                    ...
                    onChange={(selected) => setnewBlog({ ...newBlog, category_id: selected?.value || "" })}
                    isSearchable
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label className="font-semibold text-gray-700">Read Time</Label>
                    <Input
                      name="read_time"
                ...
                <div>
                  ...
                  <Editor
                    apiKey="fpm9pcn3s0frqp5v627eaup889pd8teekhx0jzfx2ihqdenp"
                    ...
                    init={{
                      ...
                      toolbar:
                        "undo redo | blocks | bold italic underline | align | bullist numlist | image link | removeformat",
                      branding: false,
                    }}
                  />
                </div>
                ...
                <div className="flex flex-col items-center space-y-4">
                  <label htmlFor="event_image" className="cursor-pointer flex flex-col items-center">
                    <div className="w-32 h-32 rounded-2xl overflow-hidden border-4 border-gradient-to-r from-indigo-500 to-pink-500 shadow-lg hover:scale-105 transition-transform">
                      {newBlog.image ? (
                        <img
                ...
                <div className="flex justify-between space-x-4 pt-4">
                  <Button
                    type="button"
                    className="flex-1 bg-gray-300 hover:bg-gray-400 text-gray-800 py-3 rounded-xl"
